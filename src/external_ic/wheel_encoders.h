...
namespace SVEA
{
    ...
    private:
        ...
        /*!
         * @brief Detect ticks from the wheel WheelEncoders.
    ...
    public:
        ...
        void setup()
        {
            ...
            // Settings for pin change interrupts for detecting wheel encoder ticks
            attachInterrupt(digitalPinToInterrupt(ENCODER_PIN_R2), encoderIsrRight, CHANGE);
            attachInterrupt(digitalPinToInterrupt(ENCODER_PIN_L2), encoderIsrLeft, CHANGE);
        }
    };

} // namespace SVEA

#endif // SVEA_WheelEncoders